...
module "aforo255-cluster6acv" {
  source          = "terraform-aws-modules/eks/aws"
  cluster_name    = "aforo255-cluster6acv"
  cluster_version = "1.17"
  subnets         = ["subnet-6b829b45", "subnet-e350f2ae"]  #CHANGE # Donot choose subnet from us-east-1e
...
data "aws_eks_cluster" "cluster" {
  name = module.aforo255-cluster6acv.cluster_id
}
